...
type EventOptions = { bubbles?: boolean, cancelable?: boolean };
...
export function closest(element: Element, selector: Selector | PredicateFn): Element | null;
...
export function dispatch(element: Element, eventType: EventType, details?: EventDetails, options?: EventOptions): boolean;
